package mySpring.inAction4.chapter10.jdbc.spittr.db.jdbc;

import mySpring.inAction4.chapter10.jdbc.spittr.db.SpittleRepository;
import mySpring.inAction4.chapter10.jdbc.spittr.domain.Spitter;
import mySpring.inAction4.chapter10.jdbc.spittr.domain.Spittle;
...
public class JdbcSpittleRepository implements SpittleRepository {
    ...
    public long count() {
        String sql = "select count(id) from Spittle";
